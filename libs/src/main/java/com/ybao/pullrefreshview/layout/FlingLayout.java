        ...
        implements NestedScrollingChild, NestedScrollingParent
{
    ...
    public void computeScroll() {
        Log.e("flingLayout", "computeScroll:");
    ...
    private void setScrollState(int stateType) {
        if (this.stateType != stateType) {
            ...
            Log.e("flingLayout", "onScrollChange:" + stateType);
    ...
    protected static void setViewTranslationY(View view, float value) {
        ...
        Log.e("flingLayout", "setViewTranslationY:");
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (mPullView != null && !ViewCompat.isNestedScrollingEnabled(mPullView)) {
            // Log.e("dispatchTouchEvent", "isNestedScrollingEnabled:");
    ...
    public boolean onStartNestedScroll(View child, View target, int nestedScrollAxes) {
        ...
        Log.e("NestedScrollingParent","onStartNestedScroll");
    ...
    public void onNestedScrollAccepted(View child, View target, int nestedScrollAxes) {
        Log.e("NestedScrollingParent","onNestedScrollAccepted");
    ...
    public void onStopNestedScroll(View target) {
        Log.e("NestedScrollingParent","onStopNestedScroll");
        startFling();
        stopNestedScroll();
    }
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed) {
        Log.e("NestedScrollingParent","onNestedScroll");
        Log.e("dyConsumed","dyConsumed:"+dyConsumed);
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed) {
        Log.e("NestedScrollingParent","onNestedPreScroll");
        Log.e("dyConsumed","dy:"+dy);
    ...
    public boolean onNestedFling(View target, float velocityX, float velocityY, boolean consumed) {
        Log.e("NestedScrollingParent","onNestedFling");
        return dispatchNestedFling(velocityX, velocityY, consumed);
    }

    @Override
    public boolean onNestedPreFling(View target, float velocityX, float velocityY) {
        Log.e("NestedScrollingParent","onNestedPreFling");
    ...
    public int getNestedScrollAxes() {
        Log.e("NestedScrollingParent","getNestedScrollAxes");
    ...
    public void setNestedScrollingEnabled(boolean enabled) {
        Log.e("NestedScrollingChild","setNestedScrollingEnabled");
        mChildHelper.setNestedScrollingEnabled(enabled);
    }

    @Override
    public boolean isNestedScrollingEnabled() {
        Log.e("NestedScrollingChild","isNestedScrollingEnabled");
        return mChildHelper.isNestedScrollingEnabled();
    }

    @Override
    public boolean startNestedScroll(int axes) {
        Log.e("NestedScrollingChild","startNestedScroll");
        return mChildHelper.startNestedScroll(axes);
    }

    @Override
    public void stopNestedScroll() {
        Log.e("NestedScrollingChild","stopNestedScroll");
        mChildHelper.stopNestedScroll();
    }

    @Override
    public boolean dispatchNestedScroll(int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int[] offsetInWindow) {
        Log.e("NestedScrollingChild","dispatchNestedScroll");
    ...
    public boolean dispatchNestedPreScroll(int dx, int dy, int[] consumed, int[] offsetInWindow) {
        Log.e("NestedScrollingChild","dispatchNestedPreScroll");
    ...
    public boolean dispatchNestedFling(float velocityX, float velocityY, boolean consumed) {
        Log.e("NestedScrollingChild","dispatchNestedFling");
        return mChildHelper.dispatchNestedFling(velocityX, velocityY, consumed);
    }

    @Override
    public boolean dispatchNestedPreFling(float velocityX, float velocityY) {
        Log.e("NestedScrollingChild","dispatchNestedPreFling");
