 ...
 * 创建时间:2016/9/6 9:46
 */
public class OneListRecycleAdapter extends BaseRecycleViewAdapter {


    private int selectPosition = -1;

    public OneListRecycleAdapter(Context context, List list) {
        super(context, list);
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new OneList(inflater.inflate(R.layout.item_one_list, parent, false));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (selectPosition == position) {
            oneList.ll_all.setBackgroundResource(R.drawable.choose_item_right);
        }
        else {
